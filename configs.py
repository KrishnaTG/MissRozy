...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','missrosy-8feab54d273d.herokuapp.com') else APP_NAME+'.herokuapp.com'
...
class Config(object):
	API_ID = int(os.environ.get("API_ID", "11071959"))
	API_HASH = os.environ.get("API_HASH", "1d5fcbb310ce34f4f767a1c6d5148beb")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","6801918345:AAHOTRcBQaFYe_mnGvMBJrCZXDoovZMNTMI")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "ProFileDump_bot")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001997428524))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5810898650"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://piratormstsaddons:LAzy@cluster0.gjllzej.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002060441744")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1002110717748")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} ")
